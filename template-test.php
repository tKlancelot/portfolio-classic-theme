...
<script>
    ...
    // tl.to(".circle-frame div:nth-child(1)", {x: 0,opacity:1, duration: 1});
    // tl.to(".circle-frame div:nth-child(1)", {x:-200,opacity: 0, duration: 1});
    // tl.to(".circle-frame div:nth-child(1)", {x:0,opacity: 1, duration: 1});
...
<script>
    ...
    //     let allLinks = document.querySelectorAll('#menu-desktop-top-menu li');

    //     allLinks.forEach((e) => {
    //         e.addEventListener('click',function(){
    //             //si un element de la list contient la class active on lui enleve la classe active
